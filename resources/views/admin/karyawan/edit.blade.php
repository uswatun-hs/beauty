...
@section('content')
<div class="card">
    <div class="card-header"><h3>Edit Karyawan</h3></div>
    <div class="card-body">
        <form action="{{ route('admin.karyawan.update', $karyawan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label>Nama</label>
                <input type="text" name="nama" value="{{ old('nama', $karyawan->nama) }}" class="form-control" required>
            ...
            <div class="mb-3">
                <label>Telepon</label>
                <input type="text" name="telepon" value="{{ old('telepon', $karyawan->telepon) }}" class="form-control">
